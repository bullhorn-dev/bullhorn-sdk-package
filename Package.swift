    ...
    targets: [
        .target(
            ...
            resources: [
                ...
                .copy("Resources/images/ic_website.png"),
                .copy("Resources/images/ic_youtube.png"),
                .copy("Resources/images/ic_facebook.png"),
                .copy("Resources/images/ic_instagram.png"),
                .copy("Resources/images/ic_twitter.png"),
                .copy("Resources/images/ic_twitch.png"),
                .copy("Resources/images/ic_linkedin.png"),

...
// MARK: BHBottomSheetTransitioningDelegate

final public class BHBottomSheetTransitioningDelegate: NSObject, UIViewControllerTransitioningDelegate {

    private weak var presentationController: BHBottomSheetPresentationController?
    ...
    var tapToDismissEnabled: Bool = true {
        didSet {
            presentationController?.tapGestureRecognizer.isEnabled = tapToDismissEnabled
        }
    }

    var panToDismissEnabled: Bool = true {
        didSet {
            presentationController?.panToDismissEnabled = panToDismissEnabled
        }
    }
    ...
    public func presentationController(
        ...
        let presentationController = BHBottomSheetPresentationController(
    ...
    public func animationController(
        ...
        guard
            let presentationController = dismissed.presentationController as? BHBottomSheetPresentationController,
            presentationController.interactiveDismissalTransition.wantsInteractiveStart
        else {
            return nil
        }

        return presentationController.interactiveDismissalTransition
    }

    public func interactionControllerForDismissal(
        using animator: UIViewControllerAnimatedTransitioning
    ) -> UIViewControllerInteractiveTransitioning? {
        animator as? BHBottomSheetInteractiveDismissalTransition
    }
}

// MARK: BHBottomSheetPresentationController

final class BHBottomSheetPresentationController: UIPresentationController {
    ...
    let interactiveDismissalTransition = BHBottomSheetInteractiveDismissalTransition()
...
// MARK: BHBottomSheetInteractiveDismissalTransition

final class BHBottomSheetInteractiveDismissalTransition: NSObject {
...
extension BHBottomSheetInteractiveDismissalTransition {
...
extension BHBottomSheetInteractiveDismissalTransition: UIViewControllerAnimatedTransitioning {
...
extension BHBottomSheetInteractiveDismissalTransition: UIViewControllerInteractiveTransitioning {

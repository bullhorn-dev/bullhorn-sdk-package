...
class BHPostPlayback: Codable, Hashable {
    ...
    init(identifier: String, episodeId: String, episodeTitle: String, podcastId: String, podcastTitle: String, startTime: TimeInterval, endTime: TimeInterval) {
    ...
    static func fromJson(_ params: [String: Any]) -> BHPostPlayback? {
        ...
        return BHPostPlayback(identifier: uuid, episodeId: episodeId, episodeTitle: episodeTitle, podcastId: podcastId, podcastTitle: podcastTitle, startTime: startedAt, endTime: finishedAt)
    }

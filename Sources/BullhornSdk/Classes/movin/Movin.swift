...
final class Movin {
    ...
    init(_ duration: TimeInterval, _ timingCurve: UITimingCurveProvider? = nil) {
        Movin.dp("Movin - init")
    ...
    @discardableResult func addAnimation(_ a: AnimationCompatible) -> Movin {
        self.animations.append(a)
        return self
    }
    
    @discardableResult func addAnimations(_ a: [AnimationCompatible]) -> Movin {
        self.animations += a
        return self
    }
    
    @discardableResult func addCompletion(_ c: @escaping (UIViewAnimatingPosition) -> Swift.Void) -> Movin {
        self.animator.addCompletion(c)
        return self
    }
    
    func startAnimation(_ mode: MovinMode = .auto) {
    ...
    func configureTransition(_ from: UIViewController, _ to: UIViewController, _ gesture: GestureTransitioning? = nil) -> Transition {
    ...
    func configureCustomTransition(_ transition: Transition) -> Transition {

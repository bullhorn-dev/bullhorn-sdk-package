...
extension Sync {
    ...
    @discardableResult
    class func fetch<ResultType: NSManagedObject>(_ id: Any, inEntityNamed entityName: String, using context: NSManagedObjectContext) throws -> ResultType? {
    ...
    /// - Throws: Core Data related issues.
    @discardableResult
    class func insertOrUpdate<ResultType: NSManagedObject>(_ changes: [String: Any], inEntityNamed entityName: String, using context: NSManagedObjectContext) throws -> ResultType {
        Sync.verifyContextSafety(context: context)
    ...
    /// - Throws: Core Data related issues.
    @discardableResult
    class func update<ResultType: NSManagedObject>(_ id: Any, with changes: [String: Any], inEntityNamed entityName: String, using context: NSManagedObjectContext) throws -> ResultType? {
        Sync.verifyContextSafety(context: context)
    ...
    ///   - context: The context to be used, make sure that this method gets called in the same thread as the context using `perform` or `performAndWait`.
    /// - Throws: Core Data related issues.
    class func delete(_ id: Any, inEntityNamed entityName: String, using context: NSManagedObjectContext) throws {
        Sync.verifyContextSafety(context: context)

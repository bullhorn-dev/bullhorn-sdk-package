...
extension NSManagedObjectContext {
    ...
    func changes(_ changes: [[String: Any]], inEntityNamed entityName: String, predicate: NSPredicate?, parent: NSManagedObject?, parentRelationship: NSRelationshipDescription?, operations: Sync.OperationOptions, completion: ((_ error: NSError?) -> Void)?) {
    ...
    ///   - completion: The completion block, it returns an error if something in the Sync process goes wrong.
    func sync(_ changes: [[String: Any]], inEntityNamed entityName: String, predicate: NSPredicate?, parent: NSManagedObject?, completion: ((_ error: NSError?) -> Void)?) {
...
extension Sync {
    ...
    ///   - completion: The completion block, it returns an error if something in the Sync process goes wrong.
    class func changes(_ changes: [[String: Any]], inEntityNamed entityName: String, inContext context: NSManagedObjectContext, operations: Sync.OperationOptions = .all, completion: ((_ error: NSError?) -> Void)?) {
    ...
    class func changes(_ changes: [[String: Any]], inEntityNamed entityName: String, predicate: NSPredicate?, parent: NSManagedObject?, parentRelationship: NSRelationshipDescription?, inContext context: NSManagedObjectContext, operations: Sync.OperationOptions, completion: ((_ error: NSError?) -> Void)?) {
     ...
     */
    class func changes(_ changes: [[String: Any]], inEntityNamed entityName: String, predicate: NSPredicate?, parent: NSManagedObject?, inContext context: NSManagedObjectContext, completion: ((_ error: NSError?) -> Void)?) {

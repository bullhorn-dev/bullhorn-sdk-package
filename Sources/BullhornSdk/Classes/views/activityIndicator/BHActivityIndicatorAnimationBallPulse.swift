...
class BHActivityIndicatorAnimationBallPulse: BHActivityIndicatorAnimationDelegate {
    ...
    func setUpAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        for i in 0 ..< 3 {
            let circle = BHActivityIndicatorShape.circle.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
